...
public class GASearchCallSetsRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GASearchCallSetsRequest(java.util.List<java.lang.CharSequence> variantSetIds, java.lang.CharSequence name, java.lang.Integer pageSize, java.lang.CharSequence pageToken) {
  ...
  /** Creates a new GASearchCallSetsRequest RecordBuilder */
  public static org.ga4gh.GASearchCallSetsRequest.Builder newBuilder() {
    return new org.ga4gh.GASearchCallSetsRequest.Builder();
  }
  
  /** Creates a new GASearchCallSetsRequest RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GASearchCallSetsRequest.Builder newBuilder(org.ga4gh.GASearchCallSetsRequest.Builder other) {
    return new org.ga4gh.GASearchCallSetsRequest.Builder(other);
  }
  
  /** Creates a new GASearchCallSetsRequest RecordBuilder by copying an existing GASearchCallSetsRequest instance */
  public static org.ga4gh.GASearchCallSetsRequest.Builder newBuilder(org.ga4gh.GASearchCallSetsRequest other) {
    return new org.ga4gh.GASearchCallSetsRequest.Builder(other);
  }
  
  /**
   * RecordBuilder for GASearchCallSetsRequest instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GASearchCallSetsRequest>
    implements org.apache.avro.data.RecordBuilder<GASearchCallSetsRequest> {
    ...
    private Builder() {
      super(org.ga4gh.GASearchCallSetsRequest.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GASearchCallSetsRequest.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GASearchCallSetsRequest instance */
    private Builder(org.ga4gh.GASearchCallSetsRequest other) {
            super(org.ga4gh.GASearchCallSetsRequest.SCHEMA$);
      if (isValidValue(fields()[0], other.variantSetIds)) {
        this.variantSetIds = data().deepCopy(fields()[0].schema(), other.variantSetIds);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'variantSetIds' field */
    public org.ga4gh.GASearchCallSetsRequest.Builder setVariantSetIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GASearchCallSetsRequest.Builder clearVariantSetIds() {
      variantSetIds = null;
    ...
    /** Sets the value of the 'name' field */
    public org.ga4gh.GASearchCallSetsRequest.Builder setName(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchCallSetsRequest.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'pageSize' field */
    public org.ga4gh.GASearchCallSetsRequest.Builder setPageSize(java.lang.Integer value) {
    ...
    public org.ga4gh.GASearchCallSetsRequest.Builder clearPageSize() {
      pageSize = null;
    ...
    /** Sets the value of the 'pageToken' field */
    public org.ga4gh.GASearchCallSetsRequest.Builder setPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchCallSetsRequest.Builder clearPageToken() {
      pageToken = null;
    ...
    @Override
    public GASearchCallSetsRequest build() {
      try {
        GASearchCallSetsRequest record = new GASearchCallSetsRequest();
