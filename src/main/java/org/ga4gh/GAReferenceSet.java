...
public class GAReferenceSet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GAReferenceSet(java.lang.CharSequence id, java.util.List<java.lang.CharSequence> referenceIds, java.lang.CharSequence md5checksum, java.lang.Integer ncbiTaxonId, java.lang.CharSequence description, java.lang.CharSequence assemblyId, java.lang.CharSequence sourceURI, java.util.List<java.lang.CharSequence> sourceAccessions, java.lang.Boolean isDerived) {
    this.id = id;
   ...
   * The IDs of the `GAReference` objects that are part of this set.   * @param value the value to set.
   */
   ...
   * A reference set may be derived from a source if it contains
  additional sequences, or some of the sequences within it are derived
  (see the definition of `isDerived` in `GAReference`).   * @param value the value to set.
   */
  public void setIsDerived(java.lang.Boolean value) {
    this.isDerived = value;
  }

  /** Creates a new GAReferenceSet RecordBuilder */
  public static org.ga4gh.GAReferenceSet.Builder newBuilder() {
    return new org.ga4gh.GAReferenceSet.Builder();
  }
  
  /** Creates a new GAReferenceSet RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAReferenceSet.Builder newBuilder(org.ga4gh.GAReferenceSet.Builder other) {
    return new org.ga4gh.GAReferenceSet.Builder(other);
  }
  
  /** Creates a new GAReferenceSet RecordBuilder by copying an existing GAReferenceSet instance */
  public static org.ga4gh.GAReferenceSet.Builder newBuilder(org.ga4gh.GAReferenceSet other) {
    return new org.ga4gh.GAReferenceSet.Builder(other);
  }
  
  /**
   * RecordBuilder for GAReferenceSet instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GAReferenceSet>
    implements org.apache.avro.data.RecordBuilder<GAReferenceSet> {
    ...
    private Builder() {
      super(org.ga4gh.GAReferenceSet.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAReferenceSet.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GAReferenceSet instance */
    private Builder(org.ga4gh.GAReferenceSet other) {
            super(org.ga4gh.GAReferenceSet.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public org.ga4gh.GAReferenceSet.Builder setId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'referenceIds' field */
    public org.ga4gh.GAReferenceSet.Builder setReferenceIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearReferenceIds() {
      referenceIds = null;
    ...
    /** Sets the value of the 'md5checksum' field */
    public org.ga4gh.GAReferenceSet.Builder setMd5checksum(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearMd5checksum() {
      md5checksum = null;
    ...
    /** Sets the value of the 'ncbiTaxonId' field */
    public org.ga4gh.GAReferenceSet.Builder setNcbiTaxonId(java.lang.Integer value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearNcbiTaxonId() {
      ncbiTaxonId = null;
    ...
    /** Sets the value of the 'description' field */
    public org.ga4gh.GAReferenceSet.Builder setDescription(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'assemblyId' field */
    public org.ga4gh.GAReferenceSet.Builder setAssemblyId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearAssemblyId() {
      assemblyId = null;
    ...
    /** Sets the value of the 'sourceURI' field */
    public org.ga4gh.GAReferenceSet.Builder setSourceURI(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearSourceURI() {
      sourceURI = null;
    ...
    /** Sets the value of the 'sourceAccessions' field */
    public org.ga4gh.GAReferenceSet.Builder setSourceAccessions(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearSourceAccessions() {
    ...
    /** Sets the value of the 'isDerived' field */
    public org.ga4gh.GAReferenceSet.Builder setIsDerived(boolean value) {
    ...
    public org.ga4gh.GAReferenceSet.Builder clearIsDerived() {
      fieldSetFlags()[8] = false;
      return this;
    }

    @Override
    public GAReferenceSet build() {
      try {
        GAReferenceSet record = new GAReferenceSet();
