...
public class GAException extends org.apache.avro.specific.SpecificExceptionBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"error\",\"name\":\"GAException\",\"namespace\":\"org.ga4gh\",\"doc\":\"A general exception type.\",\"fields\":[{\"name\":\"message\",\"type\":\"string\",\"doc\":\"The error message\"},{\"name\":\"errorCode\",\"type\":\"int\",\"doc\":\"The numerical error code\",\"default\":-1}]}");
  ...
  public static org.ga4gh.GAException.Builder newBuilder() {
    return new org.ga4gh.GAException.Builder();
  }
  
  /** Creates a new GAException RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAException.Builder newBuilder(org.ga4gh.GAException.Builder other) {
    return new org.ga4gh.GAException.Builder(other);
  }
  
  /** Creates a new GAException RecordBuilder by copying an existing GAException instance */
  public static org.ga4gh.GAException.Builder newBuilder(org.ga4gh.GAException other) {
    return new org.ga4gh.GAException.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificErrorBuilderBase<GAException>
    ...
    private Builder() {
      super(org.ga4gh.GAException.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAException.Builder other) {
      super(other);
    ...
    private Builder(org.ga4gh.GAException other) {
      super(other);
      if (isValidValue(fields()[0], other.message$)) {
        this.message$ = data().deepCopy(fields()[0].schema(), other.message$);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public org.ga4gh.GAException.Builder setValue(Object value) {
      super.setValue(value);
      return this;
    }
    
    @Override
    public org.ga4gh.GAException.Builder clearValue() {
      super.clearValue();
      return this;
    }

    @Override
    public org.ga4gh.GAException.Builder setCause(Throwable cause) {
      super.setCause(cause);
      return this;
    }
    
    @Override
    public org.ga4gh.GAException.Builder clearCause() {
      super.clearCause();
      return this;
    }
    ...
    /** Sets the value of the 'message$' field */
    public org.ga4gh.GAException.Builder setMessage$(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAException.Builder clearMessage$() {
      message$ = null;
    ...
    /** Sets the value of the 'errorCode' field */
    public org.ga4gh.GAException.Builder setErrorCode(int value) {
    ...
    public org.ga4gh.GAException.Builder clearErrorCode() {
