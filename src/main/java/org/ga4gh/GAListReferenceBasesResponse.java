...
public class GAListReferenceBasesResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GAListReferenceBasesResponse(java.lang.Long offset, java.lang.CharSequence sequence, java.lang.CharSequence nextPageToken) {
    this.offset = offset;
   ...
   * The offset position (0-based) of the given `sequence` from the start of this
  `GAReference`. This value will differ for each page in a paginated request.   * @param value the value to set.
   */
  ...
  /** Creates a new GAListReferenceBasesResponse RecordBuilder */
  public static org.ga4gh.GAListReferenceBasesResponse.Builder newBuilder() {
    return new org.ga4gh.GAListReferenceBasesResponse.Builder();
  }
  
  /** Creates a new GAListReferenceBasesResponse RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAListReferenceBasesResponse.Builder newBuilder(org.ga4gh.GAListReferenceBasesResponse.Builder other) {
    return new org.ga4gh.GAListReferenceBasesResponse.Builder(other);
  }
  
  /** Creates a new GAListReferenceBasesResponse RecordBuilder by copying an existing GAListReferenceBasesResponse instance */
  public static org.ga4gh.GAListReferenceBasesResponse.Builder newBuilder(org.ga4gh.GAListReferenceBasesResponse other) {
    return new org.ga4gh.GAListReferenceBasesResponse.Builder(other);
  }
  
  /**
   * RecordBuilder for GAListReferenceBasesResponse instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GAListReferenceBasesResponse>
    implements org.apache.avro.data.RecordBuilder<GAListReferenceBasesResponse> {
    ...
    private Builder() {
      super(org.ga4gh.GAListReferenceBasesResponse.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAListReferenceBasesResponse.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GAListReferenceBasesResponse instance */
    private Builder(org.ga4gh.GAListReferenceBasesResponse other) {
            super(org.ga4gh.GAListReferenceBasesResponse.SCHEMA$);
      if (isValidValue(fields()[0], other.offset)) {
        this.offset = data().deepCopy(fields()[0].schema(), other.offset);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'offset' field */
    public org.ga4gh.GAListReferenceBasesResponse.Builder setOffset(long value) {
    ...
    public org.ga4gh.GAListReferenceBasesResponse.Builder clearOffset() {
    ...
    /** Sets the value of the 'sequence' field */
    public org.ga4gh.GAListReferenceBasesResponse.Builder setSequence(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAListReferenceBasesResponse.Builder clearSequence() {
      sequence = null;
    ...
    /** Sets the value of the 'nextPageToken' field */
    public org.ga4gh.GAListReferenceBasesResponse.Builder setNextPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAListReferenceBasesResponse.Builder clearNextPageToken() {
      nextPageToken = null;
    ...
    @Override
    public GAListReferenceBasesResponse build() {
      try {
        GAListReferenceBasesResponse record = new GAListReferenceBasesResponse();
