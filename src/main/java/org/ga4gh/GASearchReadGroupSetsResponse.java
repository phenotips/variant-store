...
public class GASearchReadGroupSetsResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GASearchReadGroupSetsResponse(java.util.List<org.ga4gh.GAReadGroupSet> readGroupSets, java.lang.CharSequence nextPageToken) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: readGroupSets = (java.util.List<org.ga4gh.GAReadGroupSet>)value$; break;
   ...
   * The list of matching read group sets.   */
  public java.util.List<org.ga4gh.GAReadGroupSet> getReadGroupSets() {
   ...
   */
  public void setReadGroupSets(java.util.List<org.ga4gh.GAReadGroupSet> value) {
  ...
  /** Creates a new GASearchReadGroupSetsResponse RecordBuilder */
  public static org.ga4gh.GASearchReadGroupSetsResponse.Builder newBuilder() {
    return new org.ga4gh.GASearchReadGroupSetsResponse.Builder();
  }
  
  /** Creates a new GASearchReadGroupSetsResponse RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GASearchReadGroupSetsResponse.Builder newBuilder(org.ga4gh.GASearchReadGroupSetsResponse.Builder other) {
    return new org.ga4gh.GASearchReadGroupSetsResponse.Builder(other);
  }
  
  /** Creates a new GASearchReadGroupSetsResponse RecordBuilder by copying an existing GASearchReadGroupSetsResponse instance */
  public static org.ga4gh.GASearchReadGroupSetsResponse.Builder newBuilder(org.ga4gh.GASearchReadGroupSetsResponse other) {
    return new org.ga4gh.GASearchReadGroupSetsResponse.Builder(other);
  }
  
  /**
   * RecordBuilder for GASearchReadGroupSetsResponse instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GASearchReadGroupSetsResponse>
    implements org.apache.avro.data.RecordBuilder<GASearchReadGroupSetsResponse> {

    private java.util.List<org.ga4gh.GAReadGroupSet> readGroupSets;
    private java.lang.CharSequence nextPageToken;

    /** Creates a new Builder */
    private Builder() {
      super(org.ga4gh.GASearchReadGroupSetsResponse.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GASearchReadGroupSetsResponse.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GASearchReadGroupSetsResponse instance */
    private Builder(org.ga4gh.GASearchReadGroupSetsResponse other) {
            super(org.ga4gh.GASearchReadGroupSetsResponse.SCHEMA$);
      if (isValidValue(fields()[0], other.readGroupSets)) {
        this.readGroupSets = data().deepCopy(fields()[0].schema(), other.readGroupSets);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'readGroupSets' field */
    public org.ga4gh.GASearchReadGroupSetsResponse.Builder setReadGroupSets(java.util.List<org.ga4gh.GAReadGroupSet> value) {
    ...
    public org.ga4gh.GASearchReadGroupSetsResponse.Builder clearReadGroupSets() {
      readGroupSets = null;
    ...
    /** Sets the value of the 'nextPageToken' field */
    public org.ga4gh.GASearchReadGroupSetsResponse.Builder setNextPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchReadGroupSetsResponse.Builder clearNextPageToken() {
      nextPageToken = null;
    ...
    @Override
    public GASearchReadGroupSetsResponse build() {
      try {
        GASearchReadGroupSetsResponse record = new GASearchReadGroupSetsResponse();
        record.readGroupSets = fieldSetFlags()[0] ? this.readGroupSets : (java.util.List<org.ga4gh.GAReadGroupSet>) defaultValue(fields()[0]);
