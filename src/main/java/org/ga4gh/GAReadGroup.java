...
public class GAReadGroup extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public org.ga4gh.GAExperiment experiment;
  ...
  @Deprecated public java.util.List<org.ga4gh.GAProgram> programs;
   ...
   */
  public GAReadGroup(java.lang.CharSequence id, java.lang.CharSequence datasetId, java.lang.CharSequence name, java.lang.CharSequence description, java.lang.CharSequence sampleId, org.ga4gh.GAExperiment experiment, java.lang.Integer predictedInsertSize, java.lang.Long created, java.lang.Long updated, java.util.List<org.ga4gh.GAProgram> programs, java.lang.CharSequence referenceSetId, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> info) {
    this.id = id;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 9: return programs;
    case 10: return referenceSetId;
    case 11: return info;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: experiment = (org.ga4gh.GAExperiment)value$; break;
    ...
    case 9: programs = (java.util.List<org.ga4gh.GAProgram>)value$; break;
    case 10: referenceSetId = (java.lang.CharSequence)value$; break;
   ...
   * The experiment used to generate this read group.   */
  public org.ga4gh.GAExperiment getExperiment() {
    return experiment;
  }
   ...
   */
  public void setExperiment(org.ga4gh.GAExperiment value) {
   ...
   * The programs used to generate this read group.   */
  public java.util.List<org.ga4gh.GAProgram> getPrograms() {
    return programs;
  }
   ...
   */
  public void setPrograms(java.util.List<org.ga4gh.GAProgram> value) {
    this.programs = value;
  }
  ...
  /** Creates a new GAReadGroup RecordBuilder */
  public static org.ga4gh.GAReadGroup.Builder newBuilder() {
    return new org.ga4gh.GAReadGroup.Builder();
  }
  
  /** Creates a new GAReadGroup RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAReadGroup.Builder newBuilder(org.ga4gh.GAReadGroup.Builder other) {
    return new org.ga4gh.GAReadGroup.Builder(other);
  }
  
  /** Creates a new GAReadGroup RecordBuilder by copying an existing GAReadGroup instance */
  public static org.ga4gh.GAReadGroup.Builder newBuilder(org.ga4gh.GAReadGroup other) {
    return new org.ga4gh.GAReadGroup.Builder(other);
  }
  
  /**
   * RecordBuilder for GAReadGroup instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GAReadGroup>
    implements org.apache.avro.data.RecordBuilder<GAReadGroup> {
    ...
    private Builder() {
      super(org.ga4gh.GAReadGroup.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAReadGroup.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[9], other.programs)) {
        this.programs = data().deepCopy(fields()[9].schema(), other.programs);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], other.referenceSetId)) {
        this.referenceSetId = data().deepCopy(fields()[10].schema(), other.referenceSetId);
    ...
    /** Creates a Builder by copying an existing GAReadGroup instance */
    private Builder(org.ga4gh.GAReadGroup other) {
            super(org.ga4gh.GAReadGroup.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public org.ga4gh.GAReadGroup.Builder setId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'datasetId' field */
    public org.ga4gh.GAReadGroup.Builder setDatasetId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearDatasetId() {
      datasetId = null;
    ...
    /** Sets the value of the 'name' field */
    public org.ga4gh.GAReadGroup.Builder setName(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'description' field */
    public org.ga4gh.GAReadGroup.Builder setDescription(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'sampleId' field */
    public org.ga4gh.GAReadGroup.Builder setSampleId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearSampleId() {
      sampleId = null;
    ...
    /** Sets the value of the 'experiment' field */
    public org.ga4gh.GAReadGroup.Builder setExperiment(org.ga4gh.GAExperiment value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearExperiment() {
      experiment = null;
    ...
    /** Sets the value of the 'predictedInsertSize' field */
    public org.ga4gh.GAReadGroup.Builder setPredictedInsertSize(java.lang.Integer value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearPredictedInsertSize() {
    ...
    /** Sets the value of the 'created' field */
    public org.ga4gh.GAReadGroup.Builder setCreated(java.lang.Long value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearCreated() {
      created = null;
    ...
    /** Sets the value of the 'updated' field */
    public org.ga4gh.GAReadGroup.Builder setUpdated(java.lang.Long value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearUpdated() {
      updated = null;
    ...
    /** Sets the value of the 'programs' field */
    public org.ga4gh.GAReadGroup.Builder setPrograms(java.util.List<org.ga4gh.GAProgram> value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearPrograms() {
      programs = null;
    ...
    /** Sets the value of the 'referenceSetId' field */
    public org.ga4gh.GAReadGroup.Builder setReferenceSetId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearReferenceSetId() {
      referenceSetId = null;
    ...
    /** Sets the value of the 'info' field */
    public org.ga4gh.GAReadGroup.Builder setInfo(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public org.ga4gh.GAReadGroup.Builder clearInfo() {
      info = null;
    ...
    @Override
    public GAReadGroup build() {
      try {
        GAReadGroup record = new GAReadGroup();
        ...
        record.experiment = fieldSetFlags()[5] ? this.experiment : (org.ga4gh.GAExperiment) defaultValue(fields()[5]);
        ...
        record.programs = fieldSetFlags()[9] ? this.programs : (java.util.List<org.ga4gh.GAProgram>) defaultValue(fields()[9]);
        record.referenceSetId = fieldSetFlags()[10] ? this.referenceSetId : (java.lang.CharSequence) defaultValue(fields()[10]);
