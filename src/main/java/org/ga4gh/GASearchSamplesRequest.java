...
public class GASearchSamplesRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GASearchSamplesRequest() {}

  /**
   * All-args constructor.
   */
  public GASearchSamplesRequest(java.util.List<java.lang.CharSequence> individualIds, java.lang.CharSequence name, java.lang.Integer pageSize, java.lang.CharSequence pageToken) {
  ...
  /** Creates a new GASearchSamplesRequest RecordBuilder */
  public static org.ga4gh.GASearchSamplesRequest.Builder newBuilder() {
    return new org.ga4gh.GASearchSamplesRequest.Builder();
  }
  
  /** Creates a new GASearchSamplesRequest RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GASearchSamplesRequest.Builder newBuilder(org.ga4gh.GASearchSamplesRequest.Builder other) {
    return new org.ga4gh.GASearchSamplesRequest.Builder(other);
  }
  
  /** Creates a new GASearchSamplesRequest RecordBuilder by copying an existing GASearchSamplesRequest instance */
  public static org.ga4gh.GASearchSamplesRequest.Builder newBuilder(org.ga4gh.GASearchSamplesRequest other) {
    return new org.ga4gh.GASearchSamplesRequest.Builder(other);
  }
  
  /**
   * RecordBuilder for GASearchSamplesRequest instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GASearchSamplesRequest>
    implements org.apache.avro.data.RecordBuilder<GASearchSamplesRequest> {
    ...
    private Builder() {
      super(org.ga4gh.GASearchSamplesRequest.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GASearchSamplesRequest.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GASearchSamplesRequest instance */
    private Builder(org.ga4gh.GASearchSamplesRequest other) {
            super(org.ga4gh.GASearchSamplesRequest.SCHEMA$);
      if (isValidValue(fields()[0], other.individualIds)) {
        this.individualIds = data().deepCopy(fields()[0].schema(), other.individualIds);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'individualIds' field */
    public org.ga4gh.GASearchSamplesRequest.Builder setIndividualIds(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GASearchSamplesRequest.Builder clearIndividualIds() {
      individualIds = null;
    ...
    /** Sets the value of the 'name' field */
    public org.ga4gh.GASearchSamplesRequest.Builder setName(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchSamplesRequest.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'pageSize' field */
    public org.ga4gh.GASearchSamplesRequest.Builder setPageSize(java.lang.Integer value) {
    ...
    public org.ga4gh.GASearchSamplesRequest.Builder clearPageSize() {
      pageSize = null;
    ...
    /** Sets the value of the 'pageToken' field */
    public org.ga4gh.GASearchSamplesRequest.Builder setPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchSamplesRequest.Builder clearPageToken() {
      pageToken = null;
    ...
    @Override
    public GASearchSamplesRequest build() {
      try {
        GASearchSamplesRequest record = new GASearchSamplesRequest();
