...
public class GASearchReferenceSetsRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GASearchReferenceSetsRequest(java.util.List<java.lang.CharSequence> md5checksums, java.util.List<java.lang.CharSequence> accessions, java.lang.CharSequence assemblyId, java.lang.Integer pageSize, java.lang.CharSequence pageToken) {
   ...
   * If present, return the reference sets which match any of the given
  `md5checksum`s. See `GAReferenceSet::md5checksum` for details.   * @param value the value to set.
   */
  ...
  /** Creates a new GASearchReferenceSetsRequest RecordBuilder */
  public static org.ga4gh.GASearchReferenceSetsRequest.Builder newBuilder() {
    return new org.ga4gh.GASearchReferenceSetsRequest.Builder();
  }
  
  /** Creates a new GASearchReferenceSetsRequest RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GASearchReferenceSetsRequest.Builder newBuilder(org.ga4gh.GASearchReferenceSetsRequest.Builder other) {
    return new org.ga4gh.GASearchReferenceSetsRequest.Builder(other);
  }
  
  /** Creates a new GASearchReferenceSetsRequest RecordBuilder by copying an existing GASearchReferenceSetsRequest instance */
  public static org.ga4gh.GASearchReferenceSetsRequest.Builder newBuilder(org.ga4gh.GASearchReferenceSetsRequest other) {
    return new org.ga4gh.GASearchReferenceSetsRequest.Builder(other);
  }
  
  /**
   * RecordBuilder for GASearchReferenceSetsRequest instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GASearchReferenceSetsRequest>
    implements org.apache.avro.data.RecordBuilder<GASearchReferenceSetsRequest> {
    ...
    private Builder() {
      super(org.ga4gh.GASearchReferenceSetsRequest.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GASearchReferenceSetsRequest.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GASearchReferenceSetsRequest instance */
    private Builder(org.ga4gh.GASearchReferenceSetsRequest other) {
            super(org.ga4gh.GASearchReferenceSetsRequest.SCHEMA$);
      if (isValidValue(fields()[0], other.md5checksums)) {
        this.md5checksums = data().deepCopy(fields()[0].schema(), other.md5checksums);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'md5checksums' field */
    public org.ga4gh.GASearchReferenceSetsRequest.Builder setMd5checksums(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GASearchReferenceSetsRequest.Builder clearMd5checksums() {
      md5checksums = null;
    ...
    /** Sets the value of the 'accessions' field */
    public org.ga4gh.GASearchReferenceSetsRequest.Builder setAccessions(java.util.List<java.lang.CharSequence> value) {
    ...
    public org.ga4gh.GASearchReferenceSetsRequest.Builder clearAccessions() {
      accessions = null;
    ...
    /** Sets the value of the 'assemblyId' field */
    public org.ga4gh.GASearchReferenceSetsRequest.Builder setAssemblyId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchReferenceSetsRequest.Builder clearAssemblyId() {
      assemblyId = null;
    ...
    /** Sets the value of the 'pageSize' field */
    public org.ga4gh.GASearchReferenceSetsRequest.Builder setPageSize(java.lang.Integer value) {
    ...
    public org.ga4gh.GASearchReferenceSetsRequest.Builder clearPageSize() {
      pageSize = null;
    ...
    /** Sets the value of the 'pageToken' field */
    public org.ga4gh.GASearchReferenceSetsRequest.Builder setPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchReferenceSetsRequest.Builder clearPageToken() {
      pageToken = null;
    ...
    @Override
    public GASearchReferenceSetsRequest build() {
      try {
        GASearchReferenceSetsRequest record = new GASearchReferenceSetsRequest();
