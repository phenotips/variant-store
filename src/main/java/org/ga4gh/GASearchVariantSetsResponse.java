...
public class GASearchVariantSetsResponse extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GASearchVariantSetsResponse(java.util.List<org.ga4gh.GAVariantSet> variantSets, java.lang.CharSequence nextPageToken) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: variantSets = (java.util.List<org.ga4gh.GAVariantSet>)value$; break;
   ...
   * The list of matching variant sets.   */
  public java.util.List<org.ga4gh.GAVariantSet> getVariantSets() {
    return variantSets;
  }
   ...
   */
  public void setVariantSets(java.util.List<org.ga4gh.GAVariantSet> value) {
  ...
  /** Creates a new GASearchVariantSetsResponse RecordBuilder */
  public static org.ga4gh.GASearchVariantSetsResponse.Builder newBuilder() {
    return new org.ga4gh.GASearchVariantSetsResponse.Builder();
  }
  
  /** Creates a new GASearchVariantSetsResponse RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GASearchVariantSetsResponse.Builder newBuilder(org.ga4gh.GASearchVariantSetsResponse.Builder other) {
    return new org.ga4gh.GASearchVariantSetsResponse.Builder(other);
  }
  
  /** Creates a new GASearchVariantSetsResponse RecordBuilder by copying an existing GASearchVariantSetsResponse instance */
  public static org.ga4gh.GASearchVariantSetsResponse.Builder newBuilder(org.ga4gh.GASearchVariantSetsResponse other) {
    return new org.ga4gh.GASearchVariantSetsResponse.Builder(other);
  }
  
  /**
   * RecordBuilder for GASearchVariantSetsResponse instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GASearchVariantSetsResponse>
    implements org.apache.avro.data.RecordBuilder<GASearchVariantSetsResponse> {

    private java.util.List<org.ga4gh.GAVariantSet> variantSets;
    private java.lang.CharSequence nextPageToken;

    /** Creates a new Builder */
    private Builder() {
      super(org.ga4gh.GASearchVariantSetsResponse.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GASearchVariantSetsResponse.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GASearchVariantSetsResponse instance */
    private Builder(org.ga4gh.GASearchVariantSetsResponse other) {
            super(org.ga4gh.GASearchVariantSetsResponse.SCHEMA$);
      if (isValidValue(fields()[0], other.variantSets)) {
        this.variantSets = data().deepCopy(fields()[0].schema(), other.variantSets);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'variantSets' field */
    public org.ga4gh.GASearchVariantSetsResponse.Builder setVariantSets(java.util.List<org.ga4gh.GAVariantSet> value) {
    ...
    public org.ga4gh.GASearchVariantSetsResponse.Builder clearVariantSets() {
      variantSets = null;
    ...
    /** Sets the value of the 'nextPageToken' field */
    public org.ga4gh.GASearchVariantSetsResponse.Builder setNextPageToken(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GASearchVariantSetsResponse.Builder clearNextPageToken() {
      nextPageToken = null;
    ...
    @Override
    public GASearchVariantSetsResponse build() {
      try {
        GASearchVariantSetsResponse record = new GASearchVariantSetsResponse();
        record.variantSets = fieldSetFlags()[0] ? this.variantSets : (java.util.List<org.ga4gh.GAVariantSet>) defaultValue(fields()[0]);
