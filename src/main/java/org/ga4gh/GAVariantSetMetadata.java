...
public class GAVariantSetMetadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GAVariantSetMetadata(java.lang.CharSequence key, java.lang.CharSequence value, java.lang.CharSequence id, java.lang.CharSequence type, java.lang.CharSequence number, java.lang.CharSequence description, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> info) {
    this.key = key;
    this.value = value;
    this.id = id;
    this.type = type;
  ...
  /** Creates a new GAVariantSetMetadata RecordBuilder */
  public static org.ga4gh.GAVariantSetMetadata.Builder newBuilder() {
    return new org.ga4gh.GAVariantSetMetadata.Builder();
  }
  
  /** Creates a new GAVariantSetMetadata RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAVariantSetMetadata.Builder newBuilder(org.ga4gh.GAVariantSetMetadata.Builder other) {
    return new org.ga4gh.GAVariantSetMetadata.Builder(other);
  }
  
  /** Creates a new GAVariantSetMetadata RecordBuilder by copying an existing GAVariantSetMetadata instance */
  public static org.ga4gh.GAVariantSetMetadata.Builder newBuilder(org.ga4gh.GAVariantSetMetadata other) {
    return new org.ga4gh.GAVariantSetMetadata.Builder(other);
  }
  
  /**
   * RecordBuilder for GAVariantSetMetadata instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GAVariantSetMetadata>
    implements org.apache.avro.data.RecordBuilder<GAVariantSetMetadata> {
    ...
    private Builder() {
      super(org.ga4gh.GAVariantSetMetadata.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAVariantSetMetadata.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GAVariantSetMetadata instance */
    private Builder(org.ga4gh.GAVariantSetMetadata other) {
            super(org.ga4gh.GAVariantSetMetadata.SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'key' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setKey(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearKey() {
      key = null;
    ...
    /** Sets the value of the 'value' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setValue(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearValue() {
      value = null;
    ...
    /** Sets the value of the 'id' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'type' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setType(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearType() {
      type = null;
    ...
    /** Sets the value of the 'number' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setNumber(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearNumber() {
      number = null;
    ...
    /** Sets the value of the 'description' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setDescription(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'info' field */
    public org.ga4gh.GAVariantSetMetadata.Builder setInfo(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public org.ga4gh.GAVariantSetMetadata.Builder clearInfo() {
      info = null;
    ...
    @Override
    public GAVariantSetMetadata build() {
      try {
        GAVariantSetMetadata record = new GAVariantSetMetadata();
