...
public class GAIndividualGroup extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GAIndividualGroup(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence description, java.lang.Long created, java.lang.Long updated, java.lang.CharSequence type, java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> info) {
    this.id = id;
    this.name = name;
  ...
  /** Creates a new GAIndividualGroup RecordBuilder */
  public static org.ga4gh.GAIndividualGroup.Builder newBuilder() {
    return new org.ga4gh.GAIndividualGroup.Builder();
  }
  
  /** Creates a new GAIndividualGroup RecordBuilder by copying an existing Builder */
  public static org.ga4gh.GAIndividualGroup.Builder newBuilder(org.ga4gh.GAIndividualGroup.Builder other) {
    return new org.ga4gh.GAIndividualGroup.Builder(other);
  }
  
  /** Creates a new GAIndividualGroup RecordBuilder by copying an existing GAIndividualGroup instance */
  public static org.ga4gh.GAIndividualGroup.Builder newBuilder(org.ga4gh.GAIndividualGroup other) {
    return new org.ga4gh.GAIndividualGroup.Builder(other);
  }
  
  /**
   * RecordBuilder for GAIndividualGroup instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GAIndividualGroup>
    implements org.apache.avro.data.RecordBuilder<GAIndividualGroup> {
    ...
    private Builder() {
      super(org.ga4gh.GAIndividualGroup.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ga4gh.GAIndividualGroup.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing GAIndividualGroup instance */
    private Builder(org.ga4gh.GAIndividualGroup other) {
            super(org.ga4gh.GAIndividualGroup.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public org.ga4gh.GAIndividualGroup.Builder setId(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'name' field */
    public org.ga4gh.GAIndividualGroup.Builder setName(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'description' field */
    public org.ga4gh.GAIndividualGroup.Builder setDescription(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'created' field */
    public org.ga4gh.GAIndividualGroup.Builder setCreated(java.lang.Long value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearCreated() {
      created = null;
    ...
    /** Sets the value of the 'updated' field */
    public org.ga4gh.GAIndividualGroup.Builder setUpdated(java.lang.Long value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearUpdated() {
      updated = null;
    ...
    /** Sets the value of the 'type' field */
    public org.ga4gh.GAIndividualGroup.Builder setType(java.lang.CharSequence value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearType() {
      type = null;
    ...
    /** Sets the value of the 'info' field */
    public org.ga4gh.GAIndividualGroup.Builder setInfo(java.util.Map<java.lang.CharSequence,java.util.List<java.lang.CharSequence>> value) {
    ...
    public org.ga4gh.GAIndividualGroup.Builder clearInfo() {
      info = null;
    ...
    @Override
    public GAIndividualGroup build() {
      try {
        GAIndividualGroup record = new GAIndividualGroup();
